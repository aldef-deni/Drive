...
<body class="login-bg min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-white/60 subtitle-emboss">Create Your Account</p>
        </div>
        
        <!-- Register Card - Embossed -->
        <div class="embossed-card p-8 md:p-10">
            <h2 class="text-xl font-semibold text-white mb-8 title-glow">Sign Up</h2>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-5">
                    <label class="block text-white/80 text-sm mb-2 font-medium">Full Name</label>
                ...
                <div class="mb-8">
                    <label class="block text-white/80 text-sm mb-2 font-medium">Confirm Password</label>
                    <div class="input-container">
                        <div class="flex items-center">
                            <div class="pl-4 icon-emboss w-10 h-10 rounded-xl flex items-center justify-center">
                                <i class="fas fa-lock text-[#d4a843]"></i>
    ...
    <div id="verifyModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" style="background: rgba(10, 22, 40, 0.9); backdrop-filter: blur(10px);">
        <div class="embossed-card p-8 max-w-md w-full text-center" id="verifyCard">
            <!-- Animated check icon -->
            ...
            <div class="input-container rounded-2xl p-5 mb-8">
                <div class="flex items-center justify-center gap-3 mb-3">
                    <div class="icon-emboss w-12 h-12 rounded-full flex items-center justify-center">
                        <i class="fas fa-clock text-amber-400 text-xl animate-pulse"></i>
                    </div>
                </div>
                <p class="text-white font-semibold text-lg">Mohon Tunggu</p>
                <p class="text-white/60 text-sm mt-1">Untuk verifikasi oleh Admin Dekorasi</p>
            </div>
            
            <a href="{{ route('login') }}" 
                class="embossed-btn block w-full py-4 rounded-xl font-bold text-lg">
