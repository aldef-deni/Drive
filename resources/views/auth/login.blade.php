...
<head>
    ...
    <style>
        ...
        .checkbox-premium {
            ...
            width: 20px;
            height: 20px;
            background: linear-gradient(145deg, #0a1628 0%, #0c1526 100%);
            border: 1px solid rgba(212, 168, 67, 0.3);
            border-radius: 6px;
            cursor: pointer;
            position: relative;
...
<body class="login-bg min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-white/50 text-sm">Secure File Storage</p>
        </div>
        
        <!-- Login Card -->
        <div class="embossed-card p-8 md:p-10">
            <h2 class="text-2xl font-bold text-white mb-8 title-glow">Sign In</h2>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="flex items-center mb-8">
                    ...
                    <label class="text-white/60 text-sm ml-3 cursor-pointer select-none">Remember me</label>
                </div>
